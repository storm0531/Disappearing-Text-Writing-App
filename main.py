...
def game_running():
    ...
    if timer_min == 0 and timer_sec == 0:
        stop_timer = True
        end_game()
        end_popup(font_color="#FED049",bg_color="#68B984",title="you win",end_results=f"you win with {past_word_count} words wrote \n"
...
def check_typing():
    ...
    if new_word_count == past_word_count:
        ...
        if color_thickness == 1:
            ...
            end_popup(font_color="#EEEEEE",bg_color="#EB455F",title="yoy lost", end_results=f"you lost with {past_word_count} words wrote \n"
